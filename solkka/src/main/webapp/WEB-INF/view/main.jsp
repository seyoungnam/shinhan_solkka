		...
		<section class="about-area ptb-90">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
					    <div class="sec-title">
							<h2>부부 자산 관리 하기<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
							<p>아래 리스트를 선택하여 가족의 안전한 미래를 만들어 가세요!</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-4">
					    <div class="single-about-box">
							<a href="http://www.naver.com" class="appao-btn">
							<i class="icofont icofont-ruler-pencil"></i>
							<h4>부부 자산 Design</h4>
							<p>목표를 설정하여 안전한 미래를 준비하세요!</p>
							</a>
						</div>
					</div>
					<div class="col-lg-4">
					    <div class="single-about-box active">
							...
							<h4>부부 자산 Monitoring</h4>
							<p>현재 부부의 자산을 확인하여 알맞은 계획을 만드는데 참고하세요!</p>
							</a>
						</div>
					</div>
					<div class="col-lg-4">
							...
							<ul>
								<li>
									<div class="feature-box-info">
										<h4>독박 자산관리는 이제 그만!</h4>
										<p>부부의 미래는 같이 설계해 가세요! </p>
									</div>
		...
		<section class="showcase-area ptb-90">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
					    <div class="sec-title">
							<h2>신한 Flatform은 이렇게 관리 합니다.<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
							<p>목표를 이룬 부부의 자산 및 소비 패턴을 파악하여 최적화된 루트를 추천합니다.</p>
						</div>
					</div>
				</div>
				<div class="row flexbox-center">
		...
		<section class="pricing-area ptb-90" id="pricing">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
					    <div class="sec-title">
							<h2>신한 은행 추천 금융 상품<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
