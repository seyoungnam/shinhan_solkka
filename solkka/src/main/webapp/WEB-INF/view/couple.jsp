...
google.charts.load("current", {packages:['corechart']});
							  function getGraph(){
								  let data = '{"userId1":"girl2019", "userId2":"boy2019", "incomeSum":"5000000"}'
								  let fistData = 0
								  let second = 0
							    ...
							    function drawChart(fistData, second) {
								      var value = google.visualization.arrayToDataTable([
								        ...
								        ["우리 부부 총 지출", Math.ceil(fistData), "#b87333"],
								        ["신혼 부부 평균 지출", Math.ceil(second), "gold"]
								      ]);
								      ...
								      var options = {
								        title: "-우리 부부와 소득이 비슷한 사람들은 이만큼 써요-",
								        width: 500,
								        height: 600,
								        bar: {groupWidth: "95%"},
							...
							function getTable(){
							let data2 = '{"userId1":"girl2019", "userId2":"boy2019"}'
							let date = []
							axios.post("http://localhost:8000/getCardDataCouple",JSON.parse(data2)).then(resData => {
